...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SamplePlayerAnimationController : MonoBehaviour
    {
        ...
        [Space]
        [Tooltip("NEW ADDITION - Slow Down when aiming")]
        [SerializeField] private float _aimSpeed = 0.9f;
        ...
        private void CalculateMoveDirection()
        {
            ...
            //else if (WeaponController_Phase2_Aiming.IsAiming) // NEW
            //{
            //    Debug.Log("AIMING ACTIVE - Speed reduced"); // Debug line
            //    _targetMaxSpeed = _aimSpeed; // NEW - Use aim speed
            //}
            else
            {
